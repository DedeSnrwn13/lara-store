                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-3">
                                            <div class="product-title">Status</div>
                                                <select name="shipping_status" id="status" v-model="status" class="form-control">
                                            ...
                                            <template v-if="status == 'SHIPPING'">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control" value="JNE20839149021029301231" name="resi" v-model="resi">
                                                </div>
                                                <div class="col-md-2">
