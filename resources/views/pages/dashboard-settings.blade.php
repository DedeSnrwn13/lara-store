                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input name="store_name" id="name" type="text" class="form-control" value="{{ $user->store_name }}">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                  <input type="radio" class="custom-control-input" name="status" id="openStoreTrue" value="1" {{ $user->status == 1 ? 'checked' : '' }}/>
                                  <label for="openStoreTrue" class="custom-control-label">Buka</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                  <input type="radio" class="custom-control-input" name="status" id="openStoreFalse" value="0" {{ $user->status == 0 || $user->status == NULL ? 'checked' : '' }}/>
